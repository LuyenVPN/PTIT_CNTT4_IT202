CREATE DATABASE HN_KS24_CNTT4_DangVanLuyen;
USE HN_KS24_CNTT4_DangVanLuyen;
...
select g.guest_name, count(b.booking_id) as total_booking from guests g
...
SELECT b.booking_id, r.room_id, datediff(b.check_out, b.check_in) * r.price_per_day as sum from bookings b
join rooms r on b.room_id = r.room_id;
